...
@router.post("/{quotation_id}/clone", response_model=Quotation)
...
@router.post("/{quotation_id}/revise", response_model=Quotation)
...
@router.put("/{quotation_id}/items/{quotation_item_id}/image", response_model=QuotationItemResponse)
...
@router.post("/{quotation_id}/items/", response_model=QuotationItemResponse)
...
@router.put("/{quotation_id}/items/", response_model=List[QuotationItemResponse])
